...
namespace LogitackerClient
{
    ...
    class UnifyingUSB
    {
        ...
        public const UInt16 PID_CU0014_R400    = 0xc538; //?? reported by Rogan Dawes
        ...
        public UnifyingUSB()
        {
            ...
            if (this.hidpp_long_file == null) this.hidpp_long_file = Device.Open(VID, PID_CU0014_R400, HIDPP_LONG_LENGTH); // failover to R400 receiver
